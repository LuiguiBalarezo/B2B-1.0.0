...
var util = require('util'),
    ...
    utils = require('../../utils'),
    logger = require('../loggers/oechsle'),
    db = require('../../database');
...
module.exports = function (emitter, clientId, fileData, folderperiod, folderyear) {
    ...
    console.log("ruta : " + fileNameFormat);
    ...
    utilRead.readFileXLS(absolutePathToFile, false).then(function (resultsheets) {
        ...
        return utilRead.getInfoRetail("OECHSLE");
        ...
        return utilRead.getAllSales_standard(codretail, codperiod, stores, "Descripción Producto", "Vta. Período(u)");
    }).then(function (sales) {
