...
module.exports = function (emitter, clientId, fileData, folderperiod, folderyear) {
    ...
    utilRead.readFileXLS(absolutePathToFile, false).then(function (resultsheets) {
        ...
        return utilRead.getInfoRetail("RIPLEY");
        ...
        return utilRead.getRecollectStores_ripley(sheets);
    }).then(function (stores) {
        return utilRead.getInfoStores_ripley(codretail, stores);
    }).then(function (stores) {
        return utilRead.getAllSales_ripley(codretail, codperiod, stores, sheets, "E", "K");
    }).then(function (sales) {
